...
- (NSMutableArray*)notificationQueueForWebView:(UIWebView*)webView
{
    NSMutableArray *notificationQueue = [_infoList objectForKey:[NSNumber numberWithUnsignedInteger:[webView hash]]];
    if(!notificationQueue)
    {
        notificationQueue = [[NSMutableArray alloc]init];
        [_infoList setObject:notificationQueue forKey:[NSNumber numberWithUnsignedInteger:[webView hash]]];
    }
